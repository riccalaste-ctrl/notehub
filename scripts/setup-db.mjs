// Setup script - run with: node scripts/setup-db.mjs
// This will create all missing tables and configure realtime on Supabase

const supabaseUrl = 'https://kmgbacihnsjgqkdqrzqj.supabase.co';
...
async function setup() {
  ...
  for (let i = 0; i < sqlStatements.length; i++) {
    ...
    const shortSql = sql.trim().substring(0, 70);
